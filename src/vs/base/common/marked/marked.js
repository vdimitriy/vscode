...
function outputLink(cap, link, raw, lexer) {
    ...
    const title = link.title ? escape_1(link.title) : null;
...
class _Renderer {
    ...
    code({ text, lang, escaped }) {
        ...
        let _a;
        const langString = (_a = (lang || '').match(/^\S*/)) === null || _a === void 0 ? void 0 : _a[0];
        const code = text.replace(/\n$/, '') + '\n';
        if (!langString) {
            return '<pre><code>'
                + (escaped ? code : escape_1(code, true))
                + '</code></pre>\n';
        }
        ...
        for (const token of tokens) {
            ...
            switch (token.type) {
                ...
                default: {
                    ...
                    let _a, _b;
                    if ((_b = (_a = this.defaults.extensions) === null || _a === void 0 ? void 0 : _a.childTokens) === null || _b === void 0 ? void 0 : _b[genericToken.type]) {
