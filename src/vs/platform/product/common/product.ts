...
const vscodeGlobal = (_globalThis as { vscode?: { context?: { configuration(): ISandboxConfiguration | undefined } } }).vscode;
...
// _VSCODE environment
else if (_globalThis._VSCODE_PRODUCT_JSON && _globalThis._VSCODE_PACKAGE_JSON) {
	// Obtain values from product.json and package.json-data
	product = _globalThis._VSCODE_PRODUCT_JSON as unknown as IProductConfiguration;
	...
	if (!product.version) {
		const pkg = _globalThis._VSCODE_PACKAGE_JSON as { version: string };
